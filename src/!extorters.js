...
export const funfact = ["Um, um um (frustrated tongue click), um - how the f**k do you spell ****bleep bleep****", `I love building interactive web experiences <span class="text-red-500 opacity-0 hover:opacity-100">(bullsh*t)</span>`,
      "I code in JavaScript and C# but I am a bit rust(y) . \n ps I do not know rust", "There are a couple more secrets hiding around this website! To find them, be patient or lucky",`<s>I could have done a simpsons with the cloud's you know</s>(updated ~ I really am delusional)`,
      ...
      "France is Becon and knowledge is power",`You might <s>not</s> get to see this because you like foxes (updated)`, "Do you know you are a perfect?", "In the life I believe I am too competitive",`<span class='cursor-pointer' onclick='Randomdraw()'>click here for an achievement</span>`
]
